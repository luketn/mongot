...
@Suite.SuiteClasses(
    value = {
      TestIndexMetrics.TestIndexMetricsDeserialization.class,
      TestIndexMetrics.TestIndexMetricsSerialization.class,
      TestIndexMetrics.TestIndexingMetricsSerialization.class,
      TestIndexMetrics.TestQueryingMetricsSerialization.class,
      TestIndexMetrics.TestQueryFeaturesMetricsSerialization.class,
    })
public class TestIndexMetrics {
