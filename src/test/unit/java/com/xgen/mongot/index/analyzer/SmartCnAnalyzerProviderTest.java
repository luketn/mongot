...
public class SmartCnAnalyzerProviderTest {
  private static final String STOPWORDS_FILENAME = "smart-chinese-analyzer-stopwords";
  ...
  public void testStopwords() {
    ...
    Assert.assertEquals(
        new CharArraySet(stopwords, false), SmartChineseAnalyzer.getDefaultStopSet());
  }
