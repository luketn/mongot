...
public record InOperator(List<NonNullValue> values) implements ComparisonOperator {
  ...
  public BsonDocument toBson() {
    return BsonDocumentBuilder.builder().field(Fields.IN, Optional.of(this)).build();
  }

  static InOperator fromBson(BsonParseContext context, BsonValue bsonValue)
