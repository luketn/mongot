...
public record PhraseQuerySpec(FieldPath path, String query, int slop)
  ...
  static PhraseQuerySpec fromBson(DocumentParser parser) throws BsonParseException {
  ...
  public boolean equals(
    ...
    PhraseQuerySpec query = (PhraseQuerySpec) other;
