...
public class NGramTokenFilterDefinition extends TokenFilterDefinition
  ...
  public NGramTokenFilterDefinition(int minGram, int maxGram, TermNotInBounds termNotInBounds) {
    this.minGram = minGram;
    this.maxGram = maxGram;
    this.termNotInBounds = termNotInBounds;
  }

  /** Deserialize an NGramTokenFilterDefinition. */
  public static NGramTokenFilterDefinition fromBson(DocumentParser parser)
    ...
    return new NGramTokenFilterDefinition(minGram, maxGram, termNotInBounds);
  }
