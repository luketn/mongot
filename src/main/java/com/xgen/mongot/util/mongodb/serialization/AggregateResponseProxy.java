...
public class AggregateResponseProxy {
  ...
  public static class CursorProxy {
    ...
    public CursorProxy(
      ...
      BsonSerialization.throwIfMissingProperty(ns, NS_FIELD);
      BsonSerialization.throwIfMissingProperty(id, ID_FIELD);
      BsonSerialization.throwIfMissingProperty(firstBatch, FIRST_BATCH_FIELD);
