...
/**
 * ChangeStreamGetMoreResponseProxy is a proxy for the response to a <em>getMore</em> command on a
 * cursor for a change stream.
 *
 * <p>See
 * https://github.com/mongodb/mongo/blob/72788deb99186ac2628604505147e68ac53cffc5/src/mongo/db/query/cursor_response.cpp
 *
 * <p>For information about the meaning of $clusterTime and operationTime see this:
 * https://docs.mongodb.com/manual/tutorial/use-database-commands/
 *
 * <p>Documentation about the resume token can be found here:
 ...
 */
public class ChangeStreamGetMoreResponseProxy {
  ...
  @BsonCreator
  public ChangeStreamGetMoreResponseProxy(
