...
/**
 * FindCommandResponseProxy is a proxy for the response to a <em>find</em> command
 *
 * <p>See
 ...
 */
public class FindCommandResponseProxy {
  ...
  /** Constructs a new FindCommandResponseProxy. */
  @BsonCreator
  public FindCommandResponseProxy(
